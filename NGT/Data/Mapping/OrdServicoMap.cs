...
namespace NGT.Data.Mapping
{
    public class OrdServicoMap : EntityTypeConfiguration<OrdServico>
    {
        public OrdServicoMap()
        {
            ...
            Property(x => x.DescProblema).HasColumnName("ods_descproblema");
            ...
            Property(x => x.ManutencaoTipoId).HasColumnName("mti_codigo");
            ...
            Property(x => x.UsuarioId).HasColumnName("usu_codigo");
        }
    }
}
